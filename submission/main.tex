...
coarse-to-fine schedules, roughly 1{,}800 training runs in total.  Beyond
...
256) = 263{,}168$; output layer $256 \times 3 + 3 = 771$.  This yields a
...
approximately 1{,}800 training runs with a total GPU time of $\sim$20 hours.
...
analysis, VRAM profiling, JPEG comparison, multi-seed) add $\sim$1{,}560
additional runs.
...
\midrule
SIREN (full)  & float16   & 264{,}707       & 517             & 10.77 & 2.23$\times$ \\
SIREN (full)  & float32   & 264{,}707       & 1{,}034         & 21.55 & 1.11$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    Kodak images (\emph{kodim01}, building scene; \emph{kodim23}, parrot with
...
\midrule
   & \textbf{Total} & $\sim$\textbf{1{,}800} & $\sim$\textbf{20\,h} \\
\bottomrule
\end{tabular}
\end{table}
