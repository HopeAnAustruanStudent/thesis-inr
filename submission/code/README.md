...
├── slides/
│   ├── slides.md              # Main presentation (Marp)
│   ├── findings.md            # Comprehensive findings (Marp)
│   └── defense_walkthrough.md # Code walkthrough (Marp)
...
The LaTeX thesis report is in `report/main.tex`. Compile with:
```bash
...
Slides use [Marp](https://marp.app/). Render to PDF:
```bash
npx @marp-team/marp-cli slides/slides.md --pdf -o slides/slides.pdf
```
